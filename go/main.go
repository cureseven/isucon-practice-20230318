...
func (mc *MySQLConnectionEnv) ConnectDB() (*sqlx.DB, error) {
	dsn := fmt.Sprintf("%v:%v@tcp(%v:%v)/%v?parseTime=true&loc=Asia%%2FTokyo&interpolateParams=tru&allowLocalInfile=truee", mc.User, mc.Password, mc.Host, mc.Port, mc.DBName)
